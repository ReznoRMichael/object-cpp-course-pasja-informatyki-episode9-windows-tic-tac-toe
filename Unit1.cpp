...
char p1,p2,p3,p4,p5,p6,p7,p8,p9;    // p1..p9 zawartosc pol w grze - p1='n' - nic, lub 'x' lub 'o'
char kto;                           // tura gracza 'x' lub 'o'

void sprawdz()
{
    if ((p1==p2 && p2==p3 && p1!='n') ||      // poziom
       (p4==p5 && p5==p6 && p4!='n') ||
       (p7==p8 && p8==p9 && p7!='n') ||
       (p1==p4 && p4==p7 && p7!='n') ||      // pion
       (p2==p5 && p5==p8 && p8!='n') ||
       (p3==p6 && p6==p9 && p9!='n') ||
       (p1==p5 && p5==p9 && p9!='n') ||      // skos
       (p3==p5 && p5==p7 && p7!='n'))
       {
            char * w;

            if (kto=='x') w = "Circle wins!";
            else w = "Cross wins!";
